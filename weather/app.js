...
function displayWeather(data) {
    ...
    weatherData.innerHTML = `
        ...
        <img src="${weatherTypesImages[weather[0].main.toLowerCase()] || 'default.png'}" alt="Weather icon" class="w-16 h-16">
...
function displayForecast(data) {
    ...
    forecastData.innerHTML = Object.values(dailyForecasts).slice(0, 5).map(day => `
        <div class='bg-white p-4 rounded shadow'>
            ...
            <img src="${weatherTypesImages[day.weather.main.toLowerCase()] || 'default.png'}" alt="Weather icon" class="w-12 h-12">
